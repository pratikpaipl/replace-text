...
@Component({
  selector: 'im-files',
  templateUrl: 'im-files.page.html',
  styleUrls: ['im-files.page.scss'],
})
export class ImLocationPage implements OnInit, OnDestroy {
    ...
    reader.onload = (e: any) => {
      ...
      for (var i = 0; i < wb.SheetNames.length; ++i) {
        ...
        for (let k = 0; k < headers.length; k++) {
          ...
          this.fields.push({id:element,label:element,selField:element,disabled:false})
        }
        // this.fields = headers;
      }
