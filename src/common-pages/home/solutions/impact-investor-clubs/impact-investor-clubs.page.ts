...
@Component({
  selector: 'impact-investor-clubs',
  templateUrl: './impact-investor-clubs.page.html',
  styleUrls: ['./impact-investor-clubs.page.scss'],
})
export class ImpactInvestorClubs implements OnInit {
  ...
  setTitle(){
    let sTitle = this.store.getVal('website_key_127') 
    let sDesc=this.store.getVal('website_key_128')
