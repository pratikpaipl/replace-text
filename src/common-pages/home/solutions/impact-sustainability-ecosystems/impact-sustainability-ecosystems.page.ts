...
@Component({
  selector: 'impact-sustainability-ecosystems',
  templateUrl: './impact-sustainability-ecosystems.page.html',
  styleUrls: ['./impact-sustainability-ecosystems.page.scss'],
})
export class ImpactSustainabilityEcosystemsClubs implements OnInit {
  ...
  setTitle(){
    let sTitle = this.store.getVal('website_key_115'); 
    let sDesc=this.store.getVal('website_key_114');
