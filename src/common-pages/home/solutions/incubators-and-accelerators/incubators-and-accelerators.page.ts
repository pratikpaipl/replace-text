...
@Component({
  selector: 'incubators-and-accelerators',
  templateUrl: './incubators-and-accelerators.page.html',
  styleUrls: ['./incubators-and-accelerators.page.scss'],
})
export class IncubatorsAndAccelerators implements OnInit {
  ...
  setTitle(){
    let sTitle =this.store.getVal('website_key_107')
    let sDesc=this.store.getVal('website_key_106')
