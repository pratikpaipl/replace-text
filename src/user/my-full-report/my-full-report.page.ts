...
@Component({
  selector: 'my-full-report',
  templateUrl: './my-full-report.page.html',
  styleUrls: ['./my-full-report.page.scss'],
})
export class MyFullReportPage implements OnInit, OnDestroy {
